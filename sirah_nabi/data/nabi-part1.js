...
const nabiPart1 = [
    {
        id: 'adam',        period: 'Berdakwah 950 tahun (disebutkan dalam Al-Quran)',
        ...
        wife: ['Istri yang tidak beriman (disebutkan dalam Al-Quran)'],
        children: ['Anak laki-laki yang beriman', 'Anak yang tidak beriman'],name: 'Adam',
        arabicName: 'آدم',
